...
public class BlazorUserService
{
    ...
    public BlazorUserService(HttpClient httpClient, AuthenticationDataMemoryStorage authenticationDataMemoryStorage)
    {
    ...
    private ClaimsPrincipal CreateClaimsPrincipalFromToken(string token)
    {
        ...
        if (tokenHandler.CanReadToken(token))
        {
            ...
            identity = new ClaimsIdentity(jwtSecurityToken.Claims, "Blazor auth");
        }
